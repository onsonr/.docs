...
<Frame>
<img
  src="/static/images/hero-identity.png"
...
/>
  ...
  <Frame type="glass" caption="DID Client-Side Resolution" defaultOpen="true">
<img
...
/>
  ...
  <Frame type="glass" caption="User data is Anonymously Linked to the Off-Chain IPFS Vault Account System">
<img
...
<Accordion title= "The Story of Digital IDs" icon="clock">
