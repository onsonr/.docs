---
title: 2. Join the Testnet
description: "Start validating blocks on Sonr"
---

## Validating on Sonr

Sonr is based on [CometBFT](https://github.com/cometbft/cometbft),
...
become part of the active Sonr validator set.

Validators and their delegators will earn Sonr as block provisions and tokens as transaction fees through execution of
...
<Callout>Seek legal advice if you intend to run a validator.</Callout>
