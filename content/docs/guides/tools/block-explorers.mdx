...
Sonr offers two types block explorers: an EVM explorer and a Cosmos explorer.
...
Below is a list of public block explorers that support Sonr Mainnet and Testnet:
